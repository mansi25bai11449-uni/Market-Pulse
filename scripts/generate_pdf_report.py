...
print("Loading captured screenshots as base64...")
...
temp_html = "DOCUMENTS/report_final.html"
with open(temp_html, "w", encoding="utf-8") as f:
    f.write(html_final)

print("Generated DOCUMENTS/report_final.html. Launching Chromium via Playwright to print PDF...")

output_pdf = "DOCUMENTS/MarketPulse_Project_Report.pdf"
...
with sync_playwright() as p:
    ...
    page.pdf(
        ...
        footer_template='<div style="font-size: 7.5pt; color: #94a3b8; width: 100%; display: flex; justify-content: space-between; padding-left: 16mm; padding-right: 16mm; font-family: sans-serif;"><span>Mansi Kumari (23BCE10482) &middot; VIT SCOPE</span><span>Page <span class="pageNumber"></span> of <span class="totalPages"></span></span></div>',
        margin={
            "top": "18mm",
            "bottom": "20mm",
            "left": "16mm",
